var rid='1861e5c3219xd5a8e6d2xm4pea8';
...
.nosel.d-flex.room.r1861e5c3219xd5a8e6d2xm4pea8 .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
#d2.mshanaa1 .label-primary{background-color:#b77c9a!important}#d2.mshanaa1 .bg{background-color:#c2c2c2!important}#d2.mshanaa1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color:#d9cfc19e!important}#dpnl.mshanaa1{background-size: 100%;background-image: url(https://c.top4top.io/p_2592hyje30.png);background-color: #b2b2b2;  }#dpnl.mshanaa1 .light{background-color:#c2c2c2!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.mshanaa1 .nosel.fl.bg.{background-color:#c2c2c2!important;  }#users.mshanaa1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#c2c2c2 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
#users.mshanaa1 .mini.u-msg{text-align:center;}#dpnl.mshanaa1.bg{background-image:linear-gradient(225deg,#c2c2c2 0%,#fff 29%,#c2c2c2 67%,#fff 100%) */}#rooms.mshanaa1 .corner.fa.fa-user.label.uc.fa-microphone.label-danger{border-radius: 10px 0 10px!important}
...
#d0.mshanaa1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://j.top4top.io/p_2592gtc3g0.png);
    color: #484848;
    background-size: 100%;
}
...
#upro.mshanaa1 .light.fl.pro.break {
    ...
    background-image: url(https://l.top4top.io/p_2592gm1o71.jpg);
...
setInterval(function () {
    if (myroom == '1861e5c3219xd5a8e6d2xm4pea8') {
        if (msh1anaa == false) {
            msh1anaa = true;
