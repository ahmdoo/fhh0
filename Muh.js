...
div#l1,div#l2,div#l3{border-bottom:2px solid;margin-bottom:2px;border-top:2px solid;margin-top:0;border-color:#bababa;border-radius:15px ;taas:69px}
...
a.label.label-primary.fl {
    hangganan-radius: 3px!mahalaga;
    margin: 2px -155px;
    padding: 5px!mahalaga;
    margin-ibaba: 2px;
    text-align: tama! mahalaga;
}
...
.label.bg.d-flex.fl {
  ...
  margin-ibaba: 2px;
  text-align: tama !importante;
}

div#l1 input#u1 {
  border-radius: 15px;
  hangganan: 1px solid #e1e0e0;
  margin-top: 3px !important;
  text-align: center;
  taas: 25px !importante;
  lapad: 95% !importante;
  margin-kaliwa: 10px;
}
...
div#l1 na buton {
  hangganan: 1px solid #ccc !important;
  hangganan-radius: 24px !mahalaga;
  lapad: 95%!mahalaga;
  taas: 27px!mahalaga;
  padding: 0 5px!importante;
  margin-left: 10px!important;
}
span.btn.fr.fa.fa-eye {
  transform: matrix(1,0,0,1,-40,-3)!mahalaga;
}

.fa.fa-user.label.badex.label-success {
